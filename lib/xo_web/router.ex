defmodule XoWeb.Router do
  ...
  scope "/", XoWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {XoWeb.LiveUserAuth, :live_user_required}
      #
  ...
  scope "/", XoWeb do
    ...
    confirm_route Xo.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [XoWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Xo.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [XoWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]
    )
  end
